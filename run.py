...
def parse_args():
    ...
    ap.add_argument(
        ...
        type=int,
        required=True,
        help="Which of the three features to run: 1 (resolution time), 2 (label count), 3 (user participation)",
    )
...
def main():
    ...
    if args.feature == 1:
        print("Running Feature 1: Resolution Time Analysis")
        resolution_time.run()
    elif args.feature == 2:
        print("Running Feature 2: Label Count Analysis")
        label_count.run()
    elif args.feature == 3:
